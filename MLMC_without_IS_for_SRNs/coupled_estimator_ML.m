function [m1,v1,m2,v2,md,vd,CPUTime]= coupled_estimator_ML(h1,exp_number,target,M,tend)
...
% m2,v2 : mean and variance of the coarse level
...
%The difference in the processes.  You could also evaluate f(Z_1) - f(Z_2), if you are not simply 
% interested in the abundance of a particular species.
diff(1:M) = data(target,1:M)-data(S+target,1:M);
